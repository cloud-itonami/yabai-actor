...
| profile | description |
|---|---|
| `yabai-classify` | yabai-classify — R2 staging の chunk を 1 つ/回 claim して admission → candidate |
| `yabai-intel` | yabai-intel — wiki.yataverse.com 迷惑インフラ収集 bot (スパム/フィッシング/詐欺ドメイン・IP・abuse連絡先、IOCのみ、個人情報は載せない) |
| `yabai-ops` | yabai-ops — yabai-intel / yabai-staging / yabai-classify の cron 健康・manifest |
| `yabai-staging` |  |
